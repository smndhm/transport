...
- Une réponse par famille, remplie par le parent (la présence des joueurs se gère sur Kalisport, ici on organise le transport) : enfants à emmener, je viens aussi (accompagnateur), j'ai une voiture (oui / si besoin / non), et si oui le nombre de places libres en plus de soi
- Récapitulatif : enfants + accompagnateurs, voitures (+ « si besoin » en réserve pour optimiser sur le parking), places libres vs places à trouver — vert si ça passe, orange si ça passe seulement avec les voitures « si besoin », rouge sinon
